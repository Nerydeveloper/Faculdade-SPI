...
public class Testes {
    public static void main(String[] args) {
        ...
        ListaEstatica lista2 = new ListaEstatica(10); // Criando uma lista estática com capacidade para 10 elementos
        ...
        lista2.adicionarNoFim(1);
        lista2.adicionarNoFim(2);
        lista2.adicionarNoFim(3);
        lista2.adicionarNoFim(2);
        lista2.adicionarNoFim(4);
        lista2.adicionarNoFim(2);
        lista2.adicionarNoFim(17);
        ...
        lista.exibirLista();
        ListaEstatica.somarListas(lista, lista2);
        lista.exibir();
